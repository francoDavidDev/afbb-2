...
const RegistrationForm = () => {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto my-10  p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold mb-6 text-center text-primary-300 py-10">Inscripcion al torneo</h2>
      <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-6">
        ...
        <div className="col-span-2">
          <button type="submit" className="bg-primary-100 hover:bg-primary-300 trasition-all duration-300 text-white px-4 py-2 rounded-lg w-full">Enviar</button>
        </div>
      </form>
    </div>
    </div>
